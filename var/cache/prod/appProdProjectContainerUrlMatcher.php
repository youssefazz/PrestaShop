    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/sell')) {
            ...
            elseif (0 === strpos($pathinfo, '/sell/orders')) {
                ...
                if (0 === strpos($pathinfo, '/sell/orders/display-customization-image') && preg_match('#^/sell/orders/display\\-customization\\-image/(?P<orderId>\\d+)/(?P<name>.+)/(?P<value>.+)$#sD', $pathinfo, $matches)) {
